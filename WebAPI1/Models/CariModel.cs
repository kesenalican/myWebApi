...
namespace WebAPI1.Models
{
    ...
    public partial class CariModel
    {
        ...
        public long CariChecksum { get; set; }

        [JsonProperty("cari_create_user")]
        public long CariCreateUser { get; set; }

        [JsonProperty("cari_create_date")]
        public DateTimeOffset CariCreateDate { get; set; }

        [JsonProperty("cari_lastup_user")]
        public long CariLastupUser { get; set; }

        [JsonProperty("cari_lastup_date")]
        public DateTimeOffset CariLastupDate { get; set; }
        ...
        public long CariHareketTipi { get; set; }

        [JsonProperty("cari_baglanti_tipi")]
        public long CariBaglantiTipi { get; set; }

        [JsonProperty("cari_stok_alim_cinsi")]
        public long CariStokAlimCinsi { get; set; }

        [JsonProperty("cari_stok_satim_cinsi")]
        public long CariStokSatimCinsi { get; set; }
        ...
        public long CariDovizCinsi { get; set; }

        [JsonProperty("cari_doviz_cinsi1")]
        public long CariDovizCinsi1 { get; set; }

        [JsonProperty("cari_doviz_cinsi2")]
        public long CariDovizCinsi2 { get; set; }

        [JsonProperty("cari_vade_fark_yuz")]
        public long CariVadeFarkYuz { get; set; }

        [JsonProperty("cari_vade_fark_yuz1")]
        public long CariVadeFarkYuz1 { get; set; }

        [JsonProperty("cari_vade_fark_yuz2")]
        public long CariVadeFarkYuz2 { get; set; }

        [JsonProperty("cari_KurHesapSekli")]
        public long CariKurHesapSekli { get; set; }
        ...
        public long CariSatisFk { get; set; }

        [JsonProperty("cari_odeme_cinsi")]
        public long CariOdemeCinsi { get; set; }

        [JsonProperty("cari_odeme_gunu")]
        public long CariOdemeGunu { get; set; }

        [JsonProperty("cari_odemeplan_no")]
        public long CariOdemeplanNo { get; set; }

        [JsonProperty("cari_opsiyon_gun")]
        public long CariOpsiyonGun { get; set; }

        [JsonProperty("cari_cariodemetercihi")]
        public long CariCariodemetercihi { get; set; }

        [JsonProperty("cari_fatura_adres_no")]
        public long CariFaturaAdresNo { get; set; }

        [JsonProperty("cari_sevk_adres_no")]
        public long CariSevkAdresNo { get; set; }
        ...
        public long CariEftHesapNum { get; set; }
        ...
        public long CariPosOngpesyuzde { get; set; }

        [JsonProperty("cari_POS_ongtaksayi")]
        public long CariPosOngtaksayi { get; set; }

        [JsonProperty("cari_POS_ongIskOran")]
        public long CariPosOngIskOran { get; set; }

        [JsonProperty("cari_kaydagiristarihi")]
        public DateTimeOffset CariKaydagiristarihi { get; set; }

        [JsonProperty("cari_KabEdFCekTutar")]
        public long CariKabEdFCekTutar { get; set; }

        [JsonProperty("cari_hal_caritip")]
        public long CariHalCaritip { get; set; }

        [JsonProperty("cari_HalKomYuzdesi")]
        public long CariHalKomYuzdesi { get; set; }

        [JsonProperty("cari_TeslimSuresi")]
        public long CariTeslimSuresi { get; set; }
        ...
        public long CariVarsayilanGirisDepo { get; set; }

        [JsonProperty("cari_VarsayilanCikisDepo")]
        public long CariVarsayilanCikisDepo { get; set; }
        ...
        public long CariBagliOrtaklisaFirma { get; set; }
        ...
        public long CariOdemeSekli { get; set; }

        [JsonProperty("cari_TeminatMekAlacakMuhKodu")]
        [JsonConverter(typeof(ParseStringConverter))]
        public long CariTeminatMekAlacakMuhKodu { get; set; }
        ...
        [JsonConverter(typeof(ParseStringConverter))]
        public long CariTeminatMekBorcMuhKodu { get; set; }
        ...
        [JsonConverter(typeof(ParseStringConverter))]
        public long CariVerilenDepozitoTeminatMuhKodu { get; set; }
        ...
        [JsonConverter(typeof(ParseStringConverter))]
        public long CariAlinanDepozitoTeminatMuhKodu { get; set; }
        ...
        public long CariDefEfaturaCinsi { get; set; }
        ...
        public DateTimeOffset CariEfaturaBaslangicTarihi { get; set; }
        ...
        public DateTimeOffset CariEirsaliyeBaslangicTarihi { get; set; }
        ...
        public long CariKisiKimlikBilgisiAciklamaTuru { get; set; }
        ...
        public long CariDefEirsaliyeCinsi { get; set; }
        ...
        [JsonConverter(typeof(ParseStringConverter))]
        public long CariNacekodu1 { get; set; }
