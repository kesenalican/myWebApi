    ...
    public class SatisSiparisiController : Controller
    {
        ...
        public JsonResult SetSatisSiparisi(Siparis siparisler)
        {
            string query = @"INSERT INTO MikroDB_V16_2022.dbo.SIPARISLER 
                            ...
                            sip_doviz_cinsi,sip_doviz_kuru,sip_alt_doviz_kuru,sip_adresno,sip_teslimturu,sip_cagrilabilir_fl,sip_prosip_uid
                            ...
                            sip_isk6,sip_mas1,sip_mas2,sip_mas3,sip_mas4,sip_Exp_Imp_Kodu,sip_kar_orani,sip_durumu,sip_stal_uid,
                            sip_planlananmiktar,sip_teklif_uid,sip_parti_kodu,sip_lot_no,sip_projekodu,sip_fiyat_liste_no,
                            sip_Otv_Pntr,sip_Otv_Vergi,sip_otvtutari,sip_OtvVergisiz_Fl,sip_paket_kod,sip_Rez_uid,sip_harekettipi,sip_yetkili_uid,
            ...
            using (SqlConnection myCon = new SqlConnection(sqlDataSource))
            {
                ...
                using (SqlCommand myCommand = new SqlCommand(query, myCon))
                {
                    ...
                    myCommand.Parameters.AddWithValue("@sip_prosip_uid", siparisler.SipProsipUid);
                    ...
                    myCommand.Parameters.AddWithValue("@sip_stal_uid", siparisler.SipStalUid); 
                    myCommand.Parameters.AddWithValue("@sip_planlananmiktar", siparisler.SipPlanlananmiktar); 
                    myCommand.Parameters.AddWithValue("@sip_teklif_uid", siparisler.SipTeklifUid); 
                    ...
                    myCommand.Parameters.AddWithValue("@sip_Rez_uid", siparisler.SipRezUid); 
                    myCommand.Parameters.AddWithValue("@sip_harekettipi", siparisler.SipHarekettipi); 
                    myCommand.Parameters.AddWithValue("@sip_yetkili_uid", siparisler.SipYetkiliUid); 
